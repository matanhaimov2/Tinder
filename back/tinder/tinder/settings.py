...
SECRET_KEY = 'django-insecure-pz1&+urzuo$4=w9yrklsoc@=*ju=pumgt6c--v3@awb=m-m%s$'
...
SIMPLE_JWT = {
    'REFRESH_TOKEN_CLASS': 'users.views.CustomRefreshToken',  # Only if using a custom RefreshToken class
